...
# Replace the finance tab content with the new enhanced dashboard
new_finance = """              {activeTab === 'finance' && (() => {
...
start_idx = content.find("              {activeTab === 'finance' && (")
end_idx = content.find("              {activeTab === 'activity' && (")
if start_idx != -1 and end_idx != -1:
    content = content[:start_idx] + new_finance + "\n" + content[end_idx:]
elif start_idx != -1:
    # If activity is not there, maybe we just find the end of the div
    pass
